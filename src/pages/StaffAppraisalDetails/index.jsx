...
const StaffAppraisalDetail = () => {
  ...
  const { departmentName, unitName } = staffData;
  ...
  return (
    <div className="page-wrapper">
      <Helmet>
        <title>Supervisor Appraisal</title>
        <meta name="description" content="Reactify Blank Page" />
      </Helmet>
      {/* Page Content */}
      <div className="m-t-50 mx-lg-auto container-fluid">
        {/* Page Header */}
        ...
        <div className="card m-b-50 col-xl-12">
                        ...
                        <div className="profile-view">
                          ...
                          <div className="row">
                            ...
                            >
                              ...
                              <div className="col-lg-1 text-center">SUP. SCORE</div>
                              <div className="col-lg-1 text-center">FINAL RATING</div>
                            </div>
                    ...
                    <div className="card-body">
                      ...
                      <div className="profile-view">
                        ...
                        <div className="d-flex mb-2 border-bottom">
                          <div className="col-lg-12 d-flex">
                            ...
                            <h4 className="col-lg-5">Rating</h4>
                            <h4 className="col-lg-3">Appraisee Rating</h4>
                          </div>
                        </div>
                        ...
                        <div className="d-flex border-bottom">
                          <div className="col-lg-12 d-flex">
                            <div className="col-lg-4">Analytical Thinking</div>
                      ...
                      <div className="d-flex border-bottom">
                        ...
                        >
                          ...
                          <div className="col-lg-5">{strengthResult}/25</div>
                          <div className="col-lg-3">
                            {appraiseeStrengthScore
                              ? appraiseeStrengthScore
                              : 0}
                                ...
                                <div className="selected_items mt-2">
                                  {selectedBehavioralTrainings?.map(
                                    (training) => {
                                      return (
                                        <ul className="d-flex">
                                          <li className=" pr-20">{training}</li>
                                          <i
                                            onClick={() =>
                                    ...
                                    (training) => {
                                      return (
                                        <ul className="d-flex">
                                          ...
                                          <i
                                            onClick={() =>
                                              deleteTechnicalTraining(training)
                                            }
                                            className="fa fa-window-close pt-1 cursor"
                                            aria-hidden="true"
                                          ></i>
