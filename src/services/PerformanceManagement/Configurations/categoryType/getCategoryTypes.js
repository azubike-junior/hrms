...
export const getCategoryTypes = createAsyncThunk("getCategoryTypes", async () => {
  try {
    const response = await axios.get(
      `${performanceManagementConfigUrl}/GetAllCategoryTypes`
    );
...
const getCategoryTypesSlice = createSlice({
  name: "getCategoryTypes",
  initialState,
  reducers: {},
...
export default getCategoryTypesSlice.reducer;
